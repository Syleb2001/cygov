...
import { Building2, User, Mail, Lock, ChevronDown, CheckCircle, KeyRound, Loader2 } from 'lucide-react';
        ...
        try {
          const response = await fetch('/api/auth/verify-2fa', {
            ...
            body: JSON.stringify({
              ...
              token: twoFactorCode,
              secret: tempUserData.twoFactorSecret
            })
          });
          ...
          if (data.success) {
            ...
            const userResponse = await fetch('/api/auth/verify-login-2fa', {
              method: 'POST',
              headers: { 'Content-Type': 'application/json' },
              body: JSON.stringify({
                email: tempUserData.email,
            ...
            setUserAndRedirect(userData.user);
          } else {
